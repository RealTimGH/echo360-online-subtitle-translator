# Third-party notices for the packaged backend

The standalone backend contains third-party open-source runtimes and model data in addition to this project's GPL-3.0-licensed source code. This file is an attribution summary, not a replacement for the license files and package metadata shipped with those components.

- Argos Translate 1.11.0: MIT license, Copyright Argos Open Technologies, LLC. Source: <https://github.com/argosopentech/argos-translate>.
- MiniSBD 0.9.5 and its English sentence-boundary model: AGPL-3.0. Source: <https://github.com/LibreTranslate/MiniSBD>.
